...
export default function Hero() {
  ...
  return (
    <section id="home" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "1280px", margin: "0 auto", padding: "120px clamp(20px, 5vw, 40px) 80px", width: "100%" }}>
        <div style={{ maxWidth: "720px" }}>
          <div className="section-label animate-fade-up" style={{ color: "#EA7628", marginBottom: "24px" }}>
            {t("label")}
          </div>

          <h1 className="animate-fade-up-d1" style={{ fontSize: "clamp(36px, 6vw, 88px)", fontWeight: 900, lineHeight: 1.05, letterSpacing: "-0.03em", color: "#FFFFFF", marginBottom: "28px" }}>
            {t("title1")}{" "}
          ...
          <p className="animate-fade-up-d2" style={{ fontSize: "clamp(14px, 2vw, 17px)", lineHeight: 1.7, color: "rgba(255,255,255,0.72)", maxWidth: "540px", marginBottom: "44px" }}>
            {t("description")}
          </p>

          <div className="animate-fade-up-d3 hero-cta-row" style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
          ...
          <div className="animate-fade-up-d3 hero-stats" style={{ display: "flex", gap: "clamp(24px, 4vw, 48px)", marginTop: "72px", flexWrap: "wrap" }}>
            {[
              ...
              <div key={s.label}>
                <div style={{ fontSize: "clamp(28px, 4vw, 36px)", fontWeight: 900, color: "#CE5605", letterSpacing: "-0.03em" }}>{s.value}</div>
                <div style={{ fontSize: "11px", fontWeight: 600, color: "rgba(255,255,255,0.5)", letterSpacing: "0.12em", textTransform: "uppercase", marginTop: "4px" }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
