...
// Map icon name strings (from i18n JSON) to Lucide components
...
function BadgeIcon({ name }: { name: string }) {
  ...
  return <Icon size={20} color="#CE5605" />;
}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                src="/images/17H51C9fCf2h0A8k87MT.jpg"
                alt="Aviation team"
                style={{ width: "100%", height: "100%", objectFit: "cover" }}
              />
            </div>
            <div
              style={{
                ...
                boxShadow: "0 8px 32px rgba(206,86,5,0.4)",
              }}
            >
              <div
                style={{
